...
::: {.enumerate options="label=(VS\arabic*)"}
1. \( \v_1 + \v_2 = (a_1 + a_2) + (b_1 + b_2)\sqrt{2} = (a_2 + a_1) + (b_2 + b_1)\sqrt{2} = \v_2 + \v_1 \).
2. \( (\v_1 + \v_2) + \v_3 = (a_1 + a_2 + a_3) + (b_1 + b_2 + b_3)\sqrt{2} = \v_1 + (\v_2 + \v_3) \).
...
5. \( \alpha(\v_1 + \v_2) = \alpha(a_1 + a_2) + \alpha(b_1 + b_2)\sqrt{2} = (\alpha a_1 + \alpha a_2) + (\alpha b_1 + \alpha b_2)\sqrt{2} = \alpha\v_1 + \alpha\v_2 \).
6. \( (\alpha + \beta)\v_1 = (\alpha + \beta)a_1 + (\alpha + \beta)b_1\sqrt{2} = (\alpha a_1 + \beta a_1) + (\alpha b_1 + \beta b_1)\sqrt{2} = \alpha\v_1 + \beta\v_1 \).
7. \( \alpha(\beta\v_1) = \alpha(\beta a_1 + \beta b_1\sqrt{2}) = \alpha\beta a_1 + \alpha\beta b_1\sqrt{2} = (\alpha\beta)\v_1 \).
8. \( 1 \cdot \v_1 = 1 \cdot a_1 + 1 \cdot b_1\sqrt{2} = a_1 + b_1\sqrt{2} = \v_1 \).
:::
